...
type AboutStyleArticleEmailInviteProps = {
  headline: string;
  label: string;
};

/** Raised brown panel inviting readers to email James. */
export function AboutStyleArticleEmailInvite({ headline, label }: AboutStyleArticleEmailInviteProps) {
  return (
    <aside
