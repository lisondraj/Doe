  ...
  return (
    <BlogMobileShell>
      ...
      >
        <Link
          href="/blog"
          className="inline-block text-left text-[clamp(1rem,3.4vw,1.15rem)] font-medium tracking-[0.02em] text-[#6B7280] transition-colors hover:text-[#374151]"
        >
          Blog
        </Link>

        <p className="mt-6 text-left text-[clamp(1rem,3.4vw,1.2rem)] font-medium tracking-[0.02em] text-[#6B7280]">
          {article.eyebrow}
        </p>

        <h1
          className={`mt-6 max-w-[min(100%,36rem)] text-left text-[clamp(2.85rem,10.5vw,4.65rem)] font-normal leading-[1.06] tracking-[-0.03em] text-[#111827] ${lora.className}`}
        >
          {article.title}
        </h1>
        ...
        <p className="mt-10 max-w-[min(100%,34rem)] text-left text-[clamp(1.05rem,3.6vw,1.3rem)] font-semibold text-[#6B7280]">
          {article.author}
