...
import { aboutStyleFeatureShaderSurface, type AboutStyleFeatureCard } from "@/lib/blog/about-style-feature-card";
import { aboutStyleFeatureCardTocId, ABOUT_STYLE_ARTICLE_SECTION_ANCHOR } from "@/lib/blog/about-style-article-toc";
import {
  ...
  return (
    <section className="about-style-feature-cards space-y-10 iphone-page:space-y-12" aria-label="Product Highlights">
      {cards.map((card) => {
        ...
        return (
          <article key={card.id} id={aboutStyleFeatureCardTocId(card.id)} className={`about-style-feature-card ${ABOUT_STYLE_ARTICLE_SECTION_ANCHOR}`}>
            <div
