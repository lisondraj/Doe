...
/** Static model picker — trigger above, open menu below, Dr. Simon's highlighted. */
export function LinkedIn2ModelDropdown() {
  return (
    <div className={`linkedin2-model-picker ${PROTO_FONT_CLASS}`} aria-hidden>
      <div className="linkedin2-model-dropdown">
