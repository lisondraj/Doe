...
/**
 * Grain + dot grid from workflow carousel “Referral Intake” slide (box 5).
 * CSS tiling keeps dot spacing square when the hero viewport width changes.
 */
...
export const HERO_CAROUSEL_SQUARE_GRID_STYLE: CSSProperties = {
  ...
  backgroundPosition: `${GRID_CELL_PX / 2}px ${GRID_CELL_PX / 2}px`,
};
