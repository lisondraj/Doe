        ...
        {(() => {
          const descriptions = [
            [
              ...
              "AI triage, drafts, and next steps on each thread",
              "Nothing lives only in screenshots",
            ],
            [
              "Agents run follow-ups inside that inbox",
              "Charts update; paperwork gets chased—with citations",
              "Approvals shrink to what needs eyes",
            ],
            [
              "Pulls chart detail as patients speak",
              "Guidelines plus sourced web context, live",
            ...
            [
              "Outbound referrals draft with attachments",
              "Inbound parses so specialty nuance survives",
              "Both clinics pinged until booked or declined",
            ],
            [
              "Patient app between visits",
              "AVS while memory's fresh",
              "Forms finished before they arrive",
            ],
            [
              "Clinic calendar meets real life honestly",
              "Swaps weigh coverage and OR blocks",
              "Double-books caught before invites send",
            ],
            [
              "Prior auth grounded in chart facts",
              "Claims scrubbed before they leave",
              "AR you can explain without spin",
            ],
          ];
