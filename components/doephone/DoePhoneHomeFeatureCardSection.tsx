      ...
      <div className={`${DOEPHONE_SECTION_CONTENT_CENTER} home-feature-card-section__inner`}>
        ...
        >
          {showSpecialtyColumns ? (
            ...
            <div
              className="home-feature-card-section__card home-feature-card-section__card--agents-carousel flex w-full items-center justify-center layout-desktop:!h-full layout-desktop:!min-h-0 layout-desktop:!max-h-none layout-desktop:!flex-1 layout-desktop:!shrink"
            >
