...
export function DoePhoneHomeFeatureCardSection({
  ...
  return (
    ...
    >
      {/* Desktop: empty band under the fixed nav so UI can center in the below-nav area */}
      ...
      <div className={`${DOEPHONE_SECTION_CONTENT_CENTER} home-feature-card-section__inner`}>
        <div
          className={`flex min-h-0 w-full flex-col ${DOEPHONE_SECTION_CAROUSEL_INSET_X} layout-desktop:min-h-0 layout-desktop:flex-none layout-desktop:px-0`}
        >
          <div
            className={`home-feature-card-section__card w-full ${DOEPHONE_SECTION_CAROUSEL_HEIGHT} layout-desktop:!flex-none layout-desktop:!shrink`}
          >
