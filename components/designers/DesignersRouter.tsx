...
import { DesignersDesktopView } from "./DesignersDesktopView";
import { DesignersMobileView } from "./DesignersMobileView";

type Variant = "phone" | "desktop";
const QUERY = "(min-width: 1024px)";

export function DesignersRouter({ initialVariant }: { initialVariant: Variant }) {
  ...
  return variant === "desktop" ? <DesignersDesktopView /> : <DesignersMobileView />;
}
