...
function NavChromeStrip({
  ...
  return (
    <div className="px-8 py-6 iphone-page:py-[clamp(0.8125rem,0.52rem+0.378rem,1.9rem)] iphone-page:px-[max(1.25rem,calc(env(safe-area-inset-left,0px)+0.695rem))] iphone-page:pr-[max(1.25rem,env(safe-area-inset-right,0px))] flex items-center relative z-10 iphone-page:gap-[clamp(0.45rem,0.35rem+0.207rem,0.75rem)] justify-end">
      <Link
        href="/"
      ...
      <button
        type="button"
        className="flex items-center justify-center p-3 iphone-page:p-[clamp(0.625rem,0.38rem+0.329rem,0.975rem)] rounded-xl transition-colors active:bg-black/[0.04]"
        style={{ color: navTextColor }}
      ...
      >
        {mobileNavOpen ? (
          <svg
            className="w-9 h-9 iphone-page:w-[clamp(1.8rem,1.2rem+0.647rem,2.55rem)] iphone-page:h-[clamp(1.8rem,1.2rem+0.647rem,2.55rem)]"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
            aria-hidden
      ...
      <>
        ...
        <div className="fixed inset-0 z-[95] pointer-events-none" role="presentation">
          ...
          >
            ...
            <div className="shrink-0 pb-[max(1rem,calc(env(safe-area-inset-bottom,0px)+10px))] iphone-page:pb-[max(0.9375rem,calc(env(safe-area-inset-bottom,0px)+12px))] pt-4 iphone-page:pt-[clamp(0.75rem,0.52rem+0.256rem,1.25rem)] border-t border-[#ECEAE6]">
              <div
