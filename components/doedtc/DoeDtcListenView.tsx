...
export function DoeDtcListenView({
  ...
  if (!valid || !sessionId) {
    return (
      <DoeDtcPageShell>
        ...
        <DoeDtcPageHeader title={DOEDTC_LISTEN.invalidTokenTitle} />
        <p className="doedtc-muted">{DOEDTC_LISTEN.invalidTokenBody}</p>
      </DoeDtcPageShell>
    );
  }
  ...
  return (
    <DoeDtcPageShell>
      ...
      <DoeDtcPageHeader title={DOEDTC_LISTEN.pageTitle} />
