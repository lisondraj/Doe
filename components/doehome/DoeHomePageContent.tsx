...
function HeroTape() {
  ...
  return (
    <div className="doehome-scene doehome-scene--grid doehome-scene--crop-br" aria-hidden="true">
      ...
      <div className="doehome-grid doehome-grid--hero">
        ...
        {DOEHOME_HERO_TAPE.lines.map((line, index) => (
          <div
            key={line.text}
            className={`doehome-grid__row${index === 2 ? " is-this" : ""}${index < lit - 1 ? " is-on" : ""}`}
        ...
        <div className="doeinsure-wrap doehome-feature">
          <DoeInsureReveal>
            ...
            <DoeHomeShaderFrame src={DOEHOME_SHADERS.cta}>
              <div className="doehome-scene doehome-scene--focus doehome-scene--crop-bl doehome-intake is-on">
                <article className="is-on">
                  <header className="is-on">
                    <em>Waitlist</em>
                    <div>
                      <b>Bring Doe into clinic</b>
                      <span>Harbor-ready intake</span>
                    </div>
                  </header>
