...
import { LANDING_EMR_PATH } from "@/lib/site-domains";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: DOEDTC_PAGE_DESCRIPTION,
    url: `${doeDtcPublicOrigin()}${LANDING_EMR_PATH}`,
    siteName: "Doe",
    images: [
      {
        url: ogImage,
...
export default function LandingEmrLayout({ children }: { children: React.ReactNode }) {
