...
export default function DoePage() {
  ...
  useLayoutEffect(() => {
    ...
    const update = () => {
      ...
      /** Align sheet flush below measured nav bottom so first accordion row stays clear of Doe / menu chrome */
  ...
  return (
    ...
    >
                ...
                >
                  ...
                  >
                    {MOBILE_NAV_FOOTER_SLIDES.map((slide) => (
                      ...
                      >
                        <div className="relative rounded-[1.375rem] iphone-page:rounded-[clamp(1.2rem,1rem+1.4vmin,2.1rem)] overflow-hidden min-h-[28rem] iphone-page:min-h-[clamp(17rem,min(40vmin,32svh),28rem)] iphone-page:max-h-[min(28rem,min(38svh,44dvh))] shadow-[0_10px_32px_rgba(0,0,0,0.12)]">
                          <div
      ...
      <div
        ...
        id="features"
        className="min-h-[calc(var(--app-vh,100dvh)+7rem)] relative z-10 flex flex-col pt-16 pb-28 iphone-page:min-h-[calc(var(--app-vh,100dvh)+6rem)] iphone-page:pt-12 iphone-page:pb-[9.5rem] scroll-mt-[max(6.5rem,calc(env(safe-area-inset-top,0px)+5.25rem))]"
      >
        <div className="flex-1 grid grid-rows-[3fr_9fr_auto] min-h-[85vh] iphone-page:min-h-[88dvh] w-full overflow-x-hidden">
          ...
          <div
            className={`flex flex-col justify-center min-h-0 px-4 py-14 iphone-page:pt-[max(6rem,calc(env(safe-area-inset-top,0px)+5.25rem))] iphone-page:pb-9 ${narrowHorizontalInset}`}
          >
