            ...
            */}
            ...
            >
              ...
              >
                    ...
                    return (
                      <div key={item} className="border-b border-[#E6E6E6]">
                        <button
                          ...
                          className={`flex w-full items-center gap-3 text-left font-medium tracking-[-0.02em] text-gray-900 pl-4 pr-5 iphone-page:pl-[max(1rem,env(safe-area-inset-left,0px))] iphone-page:pr-[max(1.25rem,env(safe-area-inset-right,0px))] py-4 active:bg-black/[0.04] transition-colors ${inter.className} text-4xl iphone-page:text-6xl iphone-page:leading-none`}
                          onClick={() =>
                ...
                {/* Footer — rotating build capsule (matches second-section carousel gradients) + CTA */}
                <div
                      ...
                      return (
                        ...
                        >
                          ...
                          <div
                            ...
                            aria-hidden
                          />
                          {/* Big diagonal line grid — same treatment as second-section carousel box 1 */}
