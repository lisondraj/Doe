  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`pointer-events-none absolute inset-x-0 bottom-0 top-1/3 z-[12] min-h-0 w-full max-w-none pb-[max(0.15rem,env(safe-area-inset-bottom,0px))] ${narrowHorizontalInset}`}
          aria-hidden
        >
