...
import { doeDtcRouteBootstrapScript } from "@/lib/doedtc/doedtc-route-bootstrap-script";
...
const doeDtcBootstrap = doeDtcRouteBootstrapScript();
  ...
  return (
    <html lang="en" data-doeforvc-always-phone="true" suppressHydrationWarning>
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: doeDtcBootstrap }} />
      </head>
