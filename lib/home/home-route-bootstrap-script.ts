...
import { normalizeHost, DESIGNERS_SITE_HOST, PRIMARY_SITE_HOST, LEGACY_MAIN_PATH } from "@/lib/site-domains";

/** Runs before paint on legacy home routes — not marketing `/` or /doehealth. */
