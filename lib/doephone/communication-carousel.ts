...
export const DOEPHONE_COMMUNICATION_SLIDES: readonly DoePhoneCommunicationSlide[] = [
  ...
  },
  {
    ...
    menuLabel: "Billing",
    description:
      "Prior authorizations stall when staff have to chase charts, forms, and payer portals by hand. Billing puts AI on the case, pulling clinical context, completing submissions, and tracking approval status so your team stays ahead of every payer.",
    backdrop: {
      slideIndex: 1,
      label: "Billing",
      gradient:
