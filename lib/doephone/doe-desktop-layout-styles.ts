...
/** Desktop home feature band — panel + copy within one viewport-tall section (mirrors /proto). */
export const DOE_DESKTOP_FEATURE_BAND_H = "min-h-[112vh] h-[112vh]";

export const DOE_DESKTOP_FEATURE_SECTION_PAD = "py-10 md:py-14 lg:py-16 xl:py-20";

export const DOE_DESKTOP_FEATURE_COPY_PT = "pt-8 md:pt-10 lg:pt-12";

export const DOE_DESKTOP_FEATURE_TITLE_TW =
  "text-left font-[350] leading-[1.02] tracking-[-0.03em] text-[#1A1208] text-[clamp(2.65rem,4.05vw,4.05rem)] md:text-[clamp(2.78rem,3.75vw,4.28rem)] lg:text-[clamp(2.92rem,3.5vw,4.52rem)]";
