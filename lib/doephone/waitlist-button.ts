...
export const DOEPHONE_NAV_PAGE_LINK_CLASS = `inline-flex shrink-0 items-center font-normal text-black no-underline transition-opacity hover:opacity-70 active:opacity-60 text-[1.125rem] leading-none iphone-page:text-[clamp(1.22rem,1.05rem+0.98vmin,1.42rem)] ${inter.className}`;
