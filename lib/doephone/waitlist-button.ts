...
/** Join-waitlist row — larger Join Us / Investors; nav bar height unchanged. */
...
/** Join-waitlist row — larger label; same min-height as standard nav CTA. */
export const DOEPHONE_NAV_JOIN_ROW_WAITLIST_CLASS = `${DOEPHONE_NAV_CTA_BASE} px-7 text-[1.1875rem] iphone-page:px-[clamp(1.9rem,1.48rem+1.85vmin,2.45rem)] iphone-page:text-[clamp(1.38rem,1.16rem+1.12vmin,1.62rem)]`;
