...
/** Nav bar — plain black page links (Waitlist / Join Us / Investors). */
export const DOEPHONE_NAV_PAGE_LINK_CLASS = `inline-flex shrink-0 items-center font-semibold text-black no-underline transition-opacity hover:opacity-70 active:opacity-60 text-[1.0625rem] leading-none iphone-page:text-[clamp(1.12rem,0.96rem+0.92vmin,1.3rem)] ${inter.className}`;
