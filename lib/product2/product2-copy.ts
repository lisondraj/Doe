...
export const PRODUCT2_LANDING_LIVE_CONVO = [
  ...
  {
    id: "agent-prefer-time",
    role: "agent" as const,
    caller: "Doe Agent",
    callDuration: "0m50s",
    callDurationIso: "PT0M50S",
    steps: ["Visit slots", "Prior auth pending"],
    lines: ["Which day and time", "would you prefer?"],
  },
  {
    id: "caller-prefer-time",
    role: "caller" as const,
    caller: "Sarah Westfield",
    callDuration: "0m58s",
