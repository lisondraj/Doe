  ...
  incidents: [
    {
      ...
      noteExcerpt: [
        { text: "Northwell clinic ops flagged a possible ", mark: null },
        { text: "PHI path", mark: "a" },
        {
          text: " in last night’s ambient scribe session. Session ",
          mark: null,
        },
        { text: "4812", mark: "b" },
        {
          text: " captured bedside audio in Exam 4; the model transcript included ",
          mark: null,
        },
        { text: "patient identifiers", mark: "c" },
        {
          text: " before the human reviewer could redact. CloudTrail and Vanta logs are already attached for the first-pass review.",
          mark: null,
        },
      ],
      when: "Apr 12, 9:14p",
    ...
    },
    {
      ...
      noteExcerpt: [
        { text: "Inference dropped for ", mark: null },
        { text: "41 minutes", mark: "a" },
        { text: " during Northwell evening clinic hours. Release ", mark: null },
        { text: "2.14", mark: "b" },
        {
          text: " rolled to production at 5:58p; uptime monitors show ",
          mark: null,
        },
        { text: "model timeout", mark: "c" },
        {
          text: " errors across three regions before automatic rollback. PagerDuty and deployment logs are queued for Tech E&O review.",
          mark: null,
        },
      ],
      when: "Apr 9, 6:02p",
    ...
    },
    {
      ...
      noteExcerpt: [
        { text: "Health-system counsel sent written notice after a ", mark: null },
        { text: "training-set question", mark: "a" },
        { text: " surfaced in diligence. The ", mark: null },
        { text: "MSA clause", mark: "b" },
        { text: " on model provenance was cited; legal asked for the ", mark: null },
        { text: "model card", mark: "c" },
        {
          text: " and data-retention path before Friday. Internal legal note and vendor thread are attached to the Media line file.",
          mark: null,
        },
      ],
      when: "Apr 4, 11:20a",
...
export const DOEINSURE_READ = {
  ...
  packet: {
    ...
    pages: "14",
    excerpt: [
      { text: "Section 12. Insurance Requirements. Vendor shall maintain, at its sole cost, ", mark: null },
      { text: "Cyber Liability", mark: "cyber" },
      { text: " and ", mark: null },
      { text: "Technology E&O", mark: "teo" },
      { text: " coverage of not less than ", mark: null },
      { text: "$10M per claim", mark: "limit" },
      { text: " and ", mark: null },
      { text: "$20M aggregate", mark: "aggregate" },
      { text: ", naming ", mark: null },
      { text: "Northwell Health", mark: "insured" },
      { text: " as ", mark: null },
      { text: "additional insured", mark: "additional" },
      { text: " on a primary and non-contributory basis, with ", mark: null },
      { text: "waiver of subrogation", mark: "waiver" },
      { text: " in favor of the health system. Certificates due ", mark: null },
      { text: "within 10 business days", mark: "cert" },
      { text: " of execution; ", mark: null },
      { text: "30-day notice of cancellation", mark: "notice" },
      { text: " required. Coverage must remain in force for the full term and ", mark: null },
      { text: "90 days after termination", mark: "tail" },
      { text: ".", mark: null },
    ],
    fields: [
      { id: "cyber", label: "Cyber line", value: "Required" },
      { id: "teo", label: "Tech E&O", value: "Required" },
      { id: "limit", label: "Per claim", value: "$10M" },
      { id: "aggregate", label: "Aggregate", value: "$20M" },
      { id: "insured", label: "Named insured", value: "Northwell Health" },
      { id: "additional", label: "Additional insured", value: "Primary, non-contributory" },
      { id: "waiver", label: "Subrogation", value: "Waived" },
      { id: "cert", label: "Certificate", value: "10 business days" },
      { id: "notice", label: "Cancellation", value: "30-day notice" },
      { id: "tail", label: "Run-off", value: "90 days post-term" },
    ],
  },
} as const;
...
export const DOEINSURE_PHI = {
  ...
  cover: ["Cyber and privacy", "Technology E&O", "BAA and PHI pack"],
  toggles: [
    { id: "train", label: "Training data", hint: "Notes used to train" },
    { id: "infer", label: "Inference logs", hint: "Prompts and outputs" },
    { id: "room", label: "Bedside capture", hint: "Ambient in clinic" },
    { id: "loop", label: "Human in the loop", hint: "A clinician signs" },
  ],
} as const;
