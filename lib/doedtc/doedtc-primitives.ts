...
- health.chart → read_profile to pull what's saved; log/update/remove on symptoms, meds, conditions, appointments, labs. Confirm in the reply. Do not send a chart link after a write.
