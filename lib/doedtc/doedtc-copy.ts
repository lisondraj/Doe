...
export const DOEDTC_PROFILE = {
  ...
  resultsLabsViewLabel: "Lab view",
  resultsLabsViewLatest: "Latest",
  resultsLabsViewSets: "Sets",
  resultsLabsHistoryHint: "All past results for this test.",
  resultsLabsHistoryClose: "Close",
  resultsLabsEarlier: "earlier",
