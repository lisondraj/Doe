...
- Never invent what someone wants to abstain from, change, or stop. Bind vague verbs (abstain, quit, cut back, strategies, plan) to the live thread topic. If an iMessage thread-reply points at an earlier bubble, that bubble wins over a newer unrelated turn. Never default to alcohol, drugs, or any stereotype.
