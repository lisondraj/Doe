...
export function createDoeDtcPreviewSnapshot(): DoeDtcProfileSnapshot {
  ...
  return {
    ...
    results: [
      ...
      {
        id: "preview-result-tsh-mid",
        user_id: USER_ID,
        title: "TSH",
        resulted_at: "2026-02-12",
        source: "LifeLabs",
        summary: "4.1 mIU/L · 0.4–4.0",
        created_at: iso(40),
        kind: "lab",
      },
      {
        id: "preview-result-alt-mid",
        user_id: USER_ID,
        title: "ALT",
        resulted_at: "2026-02-12",
        source: "LifeLabs",
      ...
      {
        id: "preview-result-glucose-mid",
        user_id: USER_ID,
        title: "Glucose",
        resulted_at: "2026-02-12",
        source: "LifeLabs",
        summary: "5.0 mmol/L · 3.6–6.0",
        created_at: iso(40),
        kind: "lab",
      },
      {
        id: "preview-result-hba1c-old",
        user_id: USER_ID,
        title: "HbA1c",
        resulted_at: "2025-11-03",
        source: "LifeLabs",
        summary: "8.2 % · <6.5",
        created_at: iso(80),
        kind: "lab",
