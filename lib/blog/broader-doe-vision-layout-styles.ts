...
/** Broader Doe Vision article body — soft cream-white DM Sans at existing article scale. */
export const BROADER_DOE_VISION_BODY_TW = `broader-doe-body text-[clamp(1.32rem,1.12rem+0.9vmin,1.58rem)] iphone-page:text-[clamp(1.55rem,1.28rem+1.22vmin,1.95rem)] font-normal leading-[1.48] tracking-[-0.01em] text-[#F2E8DA] ${dmSans.className}`;
