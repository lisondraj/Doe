...
export const PULSE_AMBIENT_ARTICLE = {
  ...
  subheading: "Prepared before the visit. Present during it.",
  openingLede:
  ...
  openingLedeContinuation:
    "Ambient closes the gap between what Pulse learns on the phone and what physicians need in the exam room. After an agent call that schedules a visit, Ambient begins preparing that appointment automatically. Before the week starts, doctors receive one summary of every patient coming in and the context worth reviewing. When the visit begins, they tap Start on a pre-built session that listens in the room, transcribes the conversation, and pulls the right information, from the chart, from call history, or from the web, as the patient speaks so clinicians can respond without breaking eye contact.",
