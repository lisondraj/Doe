...
export const OUR_FOUNDER_STORY_ARTICLE = {
  ...
  subheading: "Learn more about Doe's founders",
  subheadingLine2: "company structure and early-stage plan",
  openingLede:
  ...
  contentBlocks: [
    ...
    {
      type: "goldParagraph",
      text: "Two different paths, trained in different disciplines, converged on the same belief about what healthcare technology should become.",
    },
    {
      type: "shader",
    ...
    {
      type: "goldParagraph",
      text: "Product, distribution, capital, recruiting, operations, and engineering can move as one system when the people leading them share the same table.",
    },
    {
      type: "paragraph",
    ...
    {
      type: "paragraph",
      text: "The larger purpose of Doe is to maximize the positive impact we can have for patients, providers, and the communities around them. That requires more than a strong product. It requires an organization designed to reach the people, resources, and partners needed to make that product matter.",
    },
    {
      type: "goldParagraph",
      text: "Every decision about company structure, geography, and access should serve the people who experience healthcare most directly.",
    },
    {
      type: "paragraph",
    ...
    {
      type: "goldParagraph",
      text: "The work ahead is not only about launching tools. It is about building relationships, earning trust, and creating technology that feels connected to the communities it serves.",
    },
    {
      type: "paragraph",
