...
export const INTRODUCING_FLOAT_ARTICLE = {
  ...
  excerpt:
    "Float is Doe's finance layer for clinics: insurance, billing, collections, and management fees in one system, powered by voice agents and the Fabric agent builder.",
  subheading: "A new way to manage clinic finances.",
  openingLede:
    "Today we're introducing Float, built for everything that happens after the visit: claims, collections, payer calls, and the overhead math that keeps multi-site groups honest.",
  openingLedeContinuation:
    "Most clinics still run revenue cycle across disconnected clearinghouses, phone trees, and spreadsheets. Float brings those workflows into one intelligent surface, with voice agents that handle payer hold times, an agent builder for custom collection flows, and automation that watches denials and balances before they become write-offs.",
  ...
  thesisPoints: [
    ...
    "Payer and patient outreach should run through agents that sound like the practice, configurable in Fabric and measurable in Float.",
