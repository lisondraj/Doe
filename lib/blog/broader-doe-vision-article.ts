...
export const BROADER_DOE_VISION_SUBHEADING = "We want providers to design their own intelligence stack.";
...
export const BROADER_DOE_VISION_BODY_PARAGRAPHS = [
  "We introduced Doe to the world less than 72 hours ago, with the belief that when providers lead the design of their own intelligent tools, we strengthen AI's ability to redefine care.",
